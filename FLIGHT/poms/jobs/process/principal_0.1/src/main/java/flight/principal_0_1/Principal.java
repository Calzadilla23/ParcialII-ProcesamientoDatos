 ...
 * @status
 */
public class Principal implements TalendJob {
	...
	private final String jobName = "Principal";
	private final String projectName = "FLIGHT";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Principal.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				flight.dimairline_0_1.DimAirline childJob_tRunJob_1 = new flight.dimairline_0_1.DimAirline();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				flight.dimairport_0_1.dimAirport childJob_tRunJob_2 = new flight.dimairport_0_1.dimAirport();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				flight.dimcity_0_1.DimCity childJob_tRunJob_3 = new flight.dimcity_0_1.DimCity();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Principal PrincipalClass = new Principal();

		int exitCode = PrincipalClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Principal.class.getClassLoader()
					.getResourceAsStream("flight/principal_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Principal.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Principal");
		}
...
/************************************************************************************************
 * 43886 characters generated by Talend Open Studio for Data Integration on the
 * 24 de octubre de 2023, 23:15:29 CST
 ************************************************************************************************/