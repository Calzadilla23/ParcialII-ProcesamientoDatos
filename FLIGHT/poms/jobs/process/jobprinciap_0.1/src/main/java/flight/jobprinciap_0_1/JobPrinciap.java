...
package flight.jobprinciap_0_1;
 ...
 * @status DEV
 */
public class JobPrinciap implements TalendJob {
	...
	private final String jobName = "JobPrinciap";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JobPrinciap.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_1.add("--context=Desarrollo");
	...
	public static void main(String[] args) {
		final JobPrinciap JobPrinciapClass = new JobPrinciap();

		int exitCode = JobPrinciapClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JobPrinciap.class.getClassLoader()
					.getResourceAsStream("flight/jobprinciap_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JobPrinciap.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JobPrinciap");
		}
...
/************************************************************************************************
 * 36825 characters generated by Talend Open Studio for Data Integration on the
 * 24 de octubre de 2023, 23:31:02 CST
 ************************************************************************************************/